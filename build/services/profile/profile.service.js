...
var ProfileService = /*#__PURE__*/function () {
  ...
  _createClass(ProfileService, [{
    key: "logins",
    value: function () {
      var _logins = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
        var employeefind, validpwd;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _logger["default"].info('inside admin login service');
              _context.prev = 1;
              _context.next = 4;
            ...
            case 7:
              _context.next = 9;
              return _bcrypt["default"].compare(password, employeefind.password);
            case 9:
              validpwd = _context.sent;
              if (validpwd) {
                _context.next = 12;
                break;
              }
            ...
            case 14:
              _context.t0 = employeefind;
              _context.next = 17;
              return (0, _auth.admin_genAccessToken)(employeefind.id, employeefind.role);
            case 17:
              _context.t1 = _context.sent;
              _context.next = 20;
              return (0, _auth.admin_genrefreshToken)(employeefind.id, employeefind.role);
            case 20:
              _context.t2 = _context.sent;
              _context.t3 = {
                accessToken: _context.t1,
                refreshToken: _context.t2
              };
              return _context.abrupt("return", {
      ...
      function logins(_x, _x2) {
        return _logins.apply(this, arguments);
      }
      return logins;
    }()
  }, {
      ...
      var _register = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, department, email, password) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              employeecreate = _context2.sent;
              _context2.t0 = employeecreate;
              _context2.next = 13;
              return (0, _auth.admin_genAccessToken)(employeecreate.id, employeecreate.role);
            case 13:
              _context2.t1 = _context2.sent;
              _context2.next = 16;
              return (0, _auth.admin_genrefreshToken)(employeecreate.id, employeecreate.role);
            case 16:
              _context2.t2 = _context2.sent;
              _context2.t3 = {
                accessToken: _context2.t1,
                refreshToken: _context2.t2
              };
              return _context2.abrupt("return", {
                message: 'successfully login companies',
                status: 200,
                employee: _context2.t0,
                token: _context2.t3
              });
            case 21:
              _context2.prev = 21;
              _context2.t4 = _context2["catch"](1);
              _logger["default"].error(_context2.t4);
              throw _context2.t4;
            case 25:
            case "end":
