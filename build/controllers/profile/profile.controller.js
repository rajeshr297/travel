...
var _profile = _interopRequireDefault(require("../../services/profile/profile.service"));
...
var PriceController = /*#__PURE__*/function () {
  function PriceController() {
    _classCallCheck(this, PriceController);
  }
  _createClass(PriceController, [{
    key: "login",
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _logger["default"].info('inside admin login controller');
              _context.prev = 1;
              _req$body = req.body, email = _req$body.email, password = _req$body.password;
              _context.next = 5;
              return _profile["default"].logins(email, password);
            case 5:
            ...
            case 9:
              ...
              _logger["default"].info("Error from controller admin login -> ".concat(_context.t0));
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              _logger["default"].info("Error from controller admin register -> ".concat(_context2.t0));
...
var _default = new PriceController();
